            ...
            <div className="row">
              ...
              <div className="col-xl-6 col-lg-6">
                <div className="contact-box bg-1 pt-60 pb-35 pl-35 pr-35 mr-40">
                  ...
                  <h3>
                    Expanded Gardening <br /> Services Fits All needs!
                  </h3>
                  <p>
                  ...
                  <ul className="mt-40">
                    <li>
                      <FaHeadphones />
                      <span>
                        Emergency Line: <Link to="/">+237 695547004</Link>
                      </span>
                    </li>
                    <li>
                      <FaEnvelopeOpen />
                      <span>
                        Our Email: <Link to="/">tchouminzikeubd@gmail.com</Link>
                      </span>
                    </li>
                    <li>
                      <FaMapMarkerAlt />
                      <span>Location: 2522 Detroit , 48212 Michigan</span>
                    </li>
                    <li>
                      <FaClock />
